...
<div className="md:col-span-3 flex flex-wrap md:flex-nowrap items-center bg-gable-green rounded-2xl py-6 md:py-2 px-6 md:pr-5 space-y-4 md:space-y-0 md:space-x-8">
  ...
  <a
    href="/tutorial"
    className="flex-none border border-1 hover:bg-gable-green border-gray-100 hover:text-white bg-gray-100 text-gable-green shadow-none transition-colors duration-200 text-white font-semibold rounded-full py-3 px-4 no-underline"
  >
    Take the Tutorial
  </a>
</div>
