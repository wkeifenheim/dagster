...
When a defining job, you can provide [resources](/concepts/resources), [configuration](/concepts/configuration/config-schema), [hooks](/concepts/solids-pipelines/op-hooks), tags, and an [executor](/deployment/executors) (follow the links for explanation of how to use each of these).
...
`to_job` accepts the same arguments as the <PyObject object="job" decorator /> decorator: you can provide [resources](/concepts/resources), [configuration](/concepts/configuration/config-schema), [hooks](/concepts/solids-pipelines/op-hooks), tags, and an [executor](/deployment/executors).
