from docs_snippets_crag.concepts.repositories_workspaces.lazy_repository_definition import (
    my_lazy_repository,
)
from docs_snippets_crag.concepts.repositories_workspaces.repository_definition import (
    job1,
    job2,
    my_repository,
)
